...
Backend desarrollado en **TypeScript** y **Node.js** para la gestión centralizada de inventarios y pedidos, integrando sistemas locales con la plataforma e-commerce WooCommerce.
...
---
*Nota de autor: Este proyecto refleja mi transición hacia arquitecturas más escalables y una mejor organización de código, priorizando el tipado fuerte y la separación de lógica en microservicios.*
